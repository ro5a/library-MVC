...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">New</span> payements</h4>
...
<div class="card mb-4">
  <h5 class="card-header">Create new Payement</h5>
  <form class="card-body" action="/save_payements" method="POST" enctype="multipart/form-data">
    
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Name of payement </label>
        <input name="payement_name" type="text" id="multicol-username" class="form-control" placeholder="payement_name" />
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password">payement activate</label>
          <div class="input-group input-group-merge">
          <label class="switch">
