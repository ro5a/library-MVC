...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">new</span> users</h4>
...
<div class="card mb-4">
  <h5 class="card-header">Create New Users</h5>
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
          <input  name="email"type="text" id="multicol-email" class="form-control" placeholder="Example@gmail.com" aria-label="john.doe" aria-describedby="multicol-email2" />
