...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_book" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Name of book </label>
        <input name="book_name" type="text" id="multicol-username" class="form-control" placeholder="book" />
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password">Book activate</label>
          <div class="input-group input-group-merge">
          <label class="switch">
