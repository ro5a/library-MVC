      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">List</span> of payements</h4>
    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-bordered">
        ...
        <tbody>
         ...
         <?php foreach($params as $payement){?>
          <tr>
            ...
            <td>
            <a href="/edit_payements/<?php echo $payement['id'];?>" class="btn btn-icon btn-outline-dribbble">
                <i class="tf-icons bx bx-edit-alt me-1"></i>
              </a>
              <button type="button" class="btn btn-icon btn-outline-dribbble"> <a href="/remove_payements/<?php echo $payement['id'];?>">
